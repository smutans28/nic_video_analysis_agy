...
try:
    ...
    from modules import file_structure_asf  # ASF/WMV
...
def identify_container(file_path):
    ...
    try:
        with open(file_path, "rb") as f:
            ...
            # Assinatura ASF (WMV)
            # 30 26 B2 75 8E 66 CF 11 -> Apenas inicio basta
            if len(header) >= 8 and header[0:8] == bytes.fromhex('3026B2758E66CF11'):
                return "ASF_WMV"
...
def analyze_atom_structure(file_path):
    ...
    elif fmt == "ASF_WMV" and file_structure_asf:
        return file_structure_asf.analyze_asf_structure(file_path)
    else:
        return {
